...
with DAG(
    ...
    def generate_days(**kwargs):
        ...
        with open('/home/airflow/data/days.csv', 'w') as f:
            write = csv.writer(f)
            write.writerow(['days'])
    ...
    def extract_csv(**kwargs):
        import time
        List_of_days = pd.read_csv('/home/airflow/data/days.csv')['days']
        Start=time.time()
        DF_all=[]
        ...
        DF_UK.to_csv('/home/airflow/data/assignment2.csv')
    ...
    def generate_plot_and_data(**kwargs):
        ...
        import matplotlib
        DF_UK = pd.read_csv('/home/airflow/data/assignment2.csv')
        font = {'weight' : 'bold',
                'size'   : 18}
